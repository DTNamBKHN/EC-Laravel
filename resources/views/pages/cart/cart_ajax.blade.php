                ...
                <tbody>
                    @if(Session::get('cart')==true)
                        ...
                        <tr>
                            ...
                            <td class="cart_total">
                                <p class="cart_total_price">{{ number_format($subtotal,0,',','.') }}đ
                                </p>
                            </td>
                        ...
                        @endforeach
                        <tr>
                            <td><input type="submit" value="Cập nhật giỏ hàng" name="update_qty" class="check_out btn btn-default btn-small"></td>
